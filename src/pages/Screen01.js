    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontFamily: "Roboto", fontSize: 26, fontWeight: '400', width: "100%", textAlign: "center" }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontFamily: "Roboto", fontSize: 26, fontWeight: '700', width: "100%", textAlign: "center" }}>
                    POWER BIKE {'\n'} SHOP
                    </Text>
            </View>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                onPress={() => {navigation.navigate("Screen02")}} >
                    <Text style={{fontFamily: "Roboto", fontSize: 26, fontWeight: '400', width: "100%", textAlign: "center"}}>Get Started</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
